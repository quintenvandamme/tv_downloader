...
def get_metadata(pageId):
    ...
    headers = {'Content-Type': 'application/json', 'Accept': 'application/graphql+json, application/json', 'encoding': 'gzip, deflate, br, zstd', 'Accept-Language': 'nl-NL,nl;q=0.9', 'X-Vrt-Client-Name':VRT_CLIENT_NAME,'X-Vrt-Client-Version': VRT_CLIENT_VERSION}
    data = {
